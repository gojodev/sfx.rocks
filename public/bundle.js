(() => {
  ...
  function loadInfo() {
    ...
    catInfo.then((catInfo2) => {
      console.log(catInfo2);
    });
    const soundInfo = Promise.resolve(getRef(categoryRef));
    soundInfo.then((soundInfo2) => {
    });
  }
  loadInfo();
